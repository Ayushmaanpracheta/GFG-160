...
// Approach 1: Brute Force:  Using Binary Search Twice: Time Complexity- O(log n) and Space Complexity-O(1)
...
// Approach 2: Using Single Binary Search: Time Complexity- O(log n) and Space Complexity-O(1)
